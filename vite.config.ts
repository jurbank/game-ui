...
/**
 * Workspace-only export condition that resolves `@gameui/*` packages to their
 ...
 */
export const sourceCondition = "@gameui/source";
...
export default defineConfig({
  ...
  lint: {
     ...
     * `@gameui/*` to packed tarballs rather than source, and has its own
